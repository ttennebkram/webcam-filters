...
Classic Matrix-style effect in pure green. Features a fixed character grid
with brightness-based rendering that converts the video to greyscale and
displays it in green only, creating the iconic Matrix aesthetic.
"""
...
class MatrixGreenEffect(BaseEffect):
    """Matrix-style fixed character grid with pure green rendering"""
    ...
    def get_description(cls):
        return "Classic Matrix effect in pure green with cascading streamers"
